...
public class PendingDriverFragment extends Fragment {

    RecyclerView recyclerView;
    ArrayList<UserList> arrayList;
    UserAdapter adapter;

    public PendingDriverFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pending_driver, container, false);
        recyclerView = view.findViewById(R.id.pending_driver_recyclerview);
