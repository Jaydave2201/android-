...
public class MainActivity1 extends AppCompatActivity implements
        TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener, View.OnClickListener, PaymentResultListener {
    ...
    private boolean isInputValid() {
        ...
        return !temp.isEmpty() && !temp1.isEmpty() && !temp2.isEmpty() &&
                !temp3.isEmpty() && !temp4.isEmpty() && !temp5.isEmpty() &&
                !temp6.isEmpty() && !temp7.isEmpty() && !temp8.isEmpty();
    }
    ...
    private void startPayment() {
        ...
        try {
            ...
            options.put("description", "Ticket Booking Payment");
            options.put("currency", "INR");
            options.put("amount", "10000"); // Amount in paise (e.g., 10000 paise = 100 INR)
            options.put("prefill.email", ""); // Optional
            options.put("prefill.contact", UserMobileNo.getText().toString()); // Optional
    ...
    private void saveTicketInformation() {
        ...
        addb1.insertEntry(
                ...
                Long.parseLong(UserMobileNo.getText().toString()),
                TicketType.getSelectedItem().toString(),
                ServiceType.getSelectedItem().toString(),
                City1.getSelectedItem().toString(),
                City2.getSelectedItem().toString(),
    ...
    private void resetSpinners() {
        ArrayAdapter<String> adapter = new ArrayAdapter<>(MainActivity1.this, android.R.layout.simple_spinner_item, Ticket);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        TicketType.setAdapter(new NothingSelectedSpinnerAdapter(adapter, R.layout.contact_spinner_row_nothing_selected, this));
        TicketType.setOnItemSelectedListener(this);
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, (view, year1, month1, dayOfMonth) -> mDateText.setText(dayOfMonth + "/" + (month1 + 1) + "/" + year1), year, month, day);
    ...
    private void showTimePickerDialog() {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(this, (view, hourOfDay, minute1) -> mTimeText.setText(hourOfDay + ":" + minute1), hour, minute, true);
